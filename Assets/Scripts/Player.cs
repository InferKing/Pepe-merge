...
public class Data
{
    public int money = 0, perClick = 1, maxMoney = 0;
    ...
    {
        money = 0; perClick = 1; extraMoney = 1f; sale = 0f;
        indexes = new List<int>();
        onField = new Dictionary<int, int>()
        {
            {0, 0},
            {1, 0},
            {2, 0},
        ...
        upgradeMenu = new Dictionary<int, int>()
        {
            {0, 0},
            {1, 0},
            {2, 0}
